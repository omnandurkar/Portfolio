    ...
    <div className=' h-[70vh] flex flex-col justify-between py-4 '>
      ...
      <div className=" grid md:grid-cols-7 grid-cols-3 md:space-y-0 space-y-10 justify-items-center mt-10 ">
        ...
        <div className="flex md:flex-row flex-col md:space-x-5 space-x-0 space-y-4 md:space-y-0  col-span-3">
          ...
          <a href='https://www.linkedin.com/in/om-nandurkar17/' className='hover:-translate-y-2 hover:scale-110 duration-300 ease-in-out text-center ' target='_blank'>
          ...
          <a href='https://github.com/omnandurkar' className='hover:-translate-y-2 hover:scale-110 duration-300 ease-in-out text-center ' target='_blank'>
          ...
          <a href='https://peerlist.io/omnandurkar/' className='hover:-translate-y-2 hover:scale-110 duration-300 ease-in-out text-center ' target='_blank'>
